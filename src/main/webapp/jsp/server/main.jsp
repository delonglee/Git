...
<body class="easyui-layout">
    ...
    <div region="north" style="height: 78px; background-color:#F0E3BF">
        <table style="padding: 5px" width="100%">
            <tr>
                <td width="50%"><img alt="log" src="${ctx}/resources/images/logo.png" style="width: 200px;height: 50px;"></td>
    ...
    <div region="west" style="width: 200px" title="网站配置" split="true">
        <div class="easyui-accordion" data-options="fit:true,border:false">
            <div title="首页管理" data-options="selected:true,iconCls:'icon-yxgl'"  style="padding: 10px">
