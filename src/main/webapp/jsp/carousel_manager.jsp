...
<html>
	<head>
		...
		<script type="text/javascript">
			$(function(){
				/*展示数据的datagrid表格*/
				$("#datagrid").datagrid({
					url:'${ctx}/carousel/carouselManager.action',
					method:'get',
					fit:true,
					singleSelect:false,
					toolbar:'#toolbar',
	...
	<body>
		...
		<div id="toolbar">
			...
			<div>
				文本信息：<input id="textInfo"  class="easyui-textbox" data-options="prompt:'文本信息'" style="width:200px">

				创建人：<input id="createMans" class="easyui-textbox"  data-options="prompt:'创建人'" style="width:200px">
				...
				<a class="easyui-linkbutton" iconCls="icon-search" href="javascript:doSearch();" >搜索</a>
			</div>
		</div>
		<!-- toolbar结束 -->

		<!-- 添加和修改的dialog 开始 -->
		<div id="dialog"  style="width:800px;height: 400px;padding: 10px 20px" >
